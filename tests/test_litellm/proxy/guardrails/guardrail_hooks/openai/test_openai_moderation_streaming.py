...
@pytest.mark.asyncio
async def test_openai_moderation_streaming_default_calls_moderation_once():
    """With the default (streaming_end_of_stream_only=True) the unified hook
    runs moderation exactly once — at end of stream — over the assembled response.
    """
    import litellm
